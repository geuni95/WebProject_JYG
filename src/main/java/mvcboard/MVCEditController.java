...
@WebServlet("/mvcedit.do")
@MultipartConfig(
	maxFileSize = 1024 * 1024 * 100,
	maxRequestSize = 1024 * 1024 * 1000
)
public class MVCEditController extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if (result == 1) { //수정 성공
			...
			resp.sendRedirect("./mvcview.do?idx="+idx);
		}
		else {
			JSFunction.alertLocation(resp, "수정에 실패했습니다.", "./mvcview.do?idx="+idx);
		}
	}
}
